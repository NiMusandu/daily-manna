...
async def handle_incoming_message(payload):
    ...
    if command.startswith("READ"):
        ...
        return await send_whatsapp_message(user_id, "✅ Bible reading progress recorded. Keep going!")
    ...
    if command == "STATS":
        ...
        if response.data:
            ...
            return await send_whatsapp_message(user_id, f"📊 You’ve completed {days} day(s) of Bible reading.")
        return await send_whatsapp_message(user_id, "📊 No progress found. Send READ after reading your Bible.")
    ...
    # Time parsing (e.g., 6:30 AM or 18:00)
    ...
    if match:
        ...
        return await send_whatsapp_message(user_id, f"⏰ Reminder time set to *{reminder_time}*.")
